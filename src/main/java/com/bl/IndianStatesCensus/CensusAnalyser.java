...
public class CensusAnalyser {
    ...
    private static String CSV_FILE_PATH="D:\\Atik\\BridgeLabz\\IndianStatesCensusAnalyser\\src\\main\\java\\com\\bl\\IndianStatesCensus\\statewise-census-data-in-india-1901-2011.csv";
    ...
    public static void main(String[] args) {
        ...
        int numOfEntry = censusAnalyzerObj.loadIndiaCensusData(CSV_FILE_PATH);
